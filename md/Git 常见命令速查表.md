\> 本文由 \[简悦 SimpRead\](http://ksria.com/simpread/) 转码， 原文地址 \[www.pnote.net\](https://www.pnote.net/gitchang-jian-ming-ling-su-cha-biao/)
...
12.  重置当前 HEAD 为指定 commit，但保持暂存区和工作区不变
