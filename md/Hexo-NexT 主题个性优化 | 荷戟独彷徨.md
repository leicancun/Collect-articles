> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [guanqr.com](https://guanqr.com/tech/website/hexo-theme-next-customization/#文章内容美化)

[[1]](#fn:1)![](https://guanqr.com/images/hexo-theme-next.png)

[](#写在前面)[写在前面](#contents:写在前面)
-------------------------------
...
[](#搭建-hexo-博客)[搭建 Hexo 博客](#contents:搭建-hexo-博客)
-------------------------------------------------

目前网上已经有很多关于如何搭建 Hexo 博客的教程了，所以此处我只进行概述，诸如博客和主题的更新方法等问题请自行谷歌搜索。

### [](#在本地安装-hexo)[在本地安装 Hexo](#contents:在本地安装-hexo)
...
点开 [http://localhost:4000/](http://localhost:4000/)，如果显示出一个简陋的博客页面，恭喜你！已经在本地搭建好博客了，下面要做的就是部署博客还有挑选一个好看的主题。

### [](#博客的部署方式)[博客的部署方式](#contents:博客的部署方式)

#### [](#github-pages)[GitHub Pages](#contents:github-pages)
...
![](https://guanqr.com/images/github-pages-enforce-https.png)
...
### [](#安装-next-主题)[安装 NexT 主题](#contents:安装-next-主题)
...
*   2020：[https://github.com/next-theme/hexo-theme-next](https://github.com/next-theme/hexo-theme-next)
...
### [](#主题配置文件)[主题配置文件](#contents:主题配置文件)

NexT 主题的配置文件内容有很多，因为该主题有很多扩展功能。在配置主题各项功能之前，我建议先阅读 [NexT 官方网站](https://theme-next.js.org/)[[2]](#fn:2) 的相关文档说明。主题配置文件内容过长，为了排版美观以及阅读方便，这里我只对一些关键配置和容易出现问题地方进行说明，一些我认为不太重要的配置就不再提及。不同版本之间的配置文件可能有微小变化，这里仅供参考。

#### [](#自定义配置)[自定义配置](#contents:自定义配置)

对应配置文件中的 `custom_file_path` 内容，如果你需要在网站的 `<head>`、`<body>` 等部位添加自己的代码，无需直接修改主题文件，NexT 主题拥有多样自由的注入功能，这一部分的说明参见下一章节「[网页样式布局](#%E7%BD%91%E9%A1%B5%E6%A0%B7%E5%BC%8F%E5%B8%83%E5%B1%80)」

#### [](#页脚信息)[页脚信息](#contents:页脚信息)
...
#### [](#导航目录配置)[导航目录配置](#contents:导航目录配置)

##### [](#一级目录)[一级目录](#contents:一级目录)
...
对于 `symbols_count_time`，即文章字数与阅读时长统计的信息，需要依赖 hexo-symbols-count-time 插件。具体的配置方法可参考该插件的[说明文档](https://github.com/theme-next/hexo-symbols-count-time)。这里提醒一下，该项功能的设定还需要在_站点配置文件_中添加以下内容：

复制

如果没有添加上述内容，则无法显示统计信息。

#### [](#相关文章)[相关文章](#contents:相关文章)

在文章的末尾添加相关（推荐）文章。因为我使用的并非是 [hexo-related-popular-posts](https://github.com/tea3/hexo-related-popular-posts) 这一款插件，而是 [hexo-recommended-posts](https://github.com/huiwang/hexo-recommended-posts)，关于该项功能的设置我并没有研究过，所以此处的具体设置请看官方说明。如果想要使用 hexo-recommended-posts 插件请看[下文](#%E6%96%87%E6%9C%AB%E6%B7%BB%E5%8A%A0%E7%9B%B8%E5%85%B3%E6%96%87%E7%AB%A0)。
...
#### [](#图片浏览)[图片浏览](#contents:图片浏览)

实现该功能的基础是在文章中[插入图片](#%E5%9B%BE%E7%89%87)。该项功能的效果是：点击文中插图，图片能够放大，有幻灯片的效果。目前 NexT 提供了两款插件 fancybox 和 mediumzoom，两款插件开启一个即可。两款插件的效果不同，各有各的特点，我推荐使用 mediumzoom。
...
#### [](#评论系统)[评论系统](#contents:评论系统)

参见文章《[Hexo-NexT 主题添加评论系统](../../../tech/website/hexo-theme-next-comments/)》。

#### [](#访客统计)[访客统计](#contents:访客统计)

##### [](#leancloud)[Leancloud](#contents:leancloud)
...
##### [](#不蒜子)[不蒜子](#contents:不蒜子)

![](https://guanqr.com/images/hexo-theme-next-busuanzi.png)
...
目前网络中的大部分优化教程都是依据旧版主题进行设定的，因此，一些使用最新版本主题的读者根据旧版设定进行操作的话，可能会报错。为了体现本文的与时俱进，本文中采用的即为_新版的设定方式_，旧版的设定方式在这里不再提及，请采用旧版主题的读者参考过去版本的官方说明文档。

### [](#基本修改方法)[基本修改方法](#contents:基本修改方法)
...
![](https://guanqr.com/images/hexo-theme-next-f12.png)◎ 进行调试
...
### [](#我的-stylesstyl)[我的 styles.styl](#contents:我的-stylesstyl)
...
### [](#修改字体)[修改字体](#contents:修改字体)

参见文章《[网站字体优化方案](../../../tech/website/web-font-guide/)》。

### [](#归档页面添加十二生肖)[归档页面添加十二生肖](#contents:归档页面添加十二生肖)

![](https://guanqr.com/images/add-chinese-zodiac-to-next-title.jpg)
...
### [](#添加球形标签云样式)[添加球形标签云样式](#contents:添加球形标签云样式)

![](https://guanqr.com/images/tag-cloud.gif)◎ 标签云样式
...
### [](#添加线状动态背景)[添加线状动态背景](#contents:添加线状动态背景)

![](https://guanqr.com/images/dynamic-bg.gif)◎ 动画示例
...
### [](#添加网站崩溃欺骗)[添加网站崩溃欺骗](#contents:添加网站崩溃欺骗)
...
### [](#添加点击爱心特效)[添加点击爱心特效](#contents:添加点击爱心特效)
...
### [](#添加评论输入特效)[添加评论输入特效](#contents:添加评论输入特效)
...
### [](#添加页脚微信订阅)[添加页脚微信订阅](#contents:添加页脚微信订阅)
...
### [](#添加阿里图标支持)[添加阿里图标支持](#contents:添加阿里图标支持)
...
### [](#添加友情链接页面)[添加友情链接页面](#contents:添加友情链接页面)

![](https://guanqr.com/images/blogroll-old-style.png)

NexT 主题自带的友情链接的位置是在侧栏的 Social Link 中，位置不太明显，而且容量比较小，不美观。因此可以自定义一个特定的页面，单独显示友情链接 [[3]](#fn:3)。
...
[](#文章内容美化)[文章内容美化](#contents:文章内容美化)
-------------------------------------

### [](#主题自带样式)[主题自带样式](#contents:主题自带样式)
...
### [](#自定义样式)[自定义样式](#contents:自定义样式)

由于是自定义的样式，故要自己将 CSS 代码加到 `styles.styl` 中，下文的自定义样式都是如此。点击[这里](http://www.divcss5.com/rumen/r3.shtml)了解一些 CSS 中 `id` 和 `class` 的知识 [[4]](#fn:4)。

#### [](#引用样式)[引用样式](#contents:引用样式)
...
如果你使用了 NexT 主题的[图片浏览功能](#%E5%9B%BE%E7%89%87%E6%B5%8F%E8%A7%88)中的 fancybox，则会在图片下方渲染出图片的说明文字。不过，如果你不想使用 fancybox，却也想渲染图片的说明文字，就必须对 Hexo 的渲染组件进行修改。
...
### [](#插入动态图表)[插入动态图表](#contents:插入动态图表)

[ECharts](http://echarts.baidu.com/index.html)，一个纯 JavaScript 的图表库，可以流畅的运行在 PC 和移动设备上。ECharts 作为国产工具，在语言上对中文开发者有着天然的优势，官方文档对每一个细节、参数、配置都有详尽的说明，对于新手非常的友好。另外一个重要的方面，就是 ECharts 的图表颜值很高，默认的主题和配色可以呈现出优雅漂亮的图表 [[5]](#fn:5)。
...
![](https://guanqr.com/images/echarts-tushuo.gif)
...
### [](#段落标题添加锚点)[段落标题添加锚点](#contents:段落标题添加锚点)
...
!function(e,t,a){function n(){c(".heart{width: 10px;height: 10px;position: fixed;background: #f00;transform: rotate(45deg);-webkit-transform: rotate(45deg);-moz-transform: rotate(45deg);}.heart:after,.heart:before{content: '';width: inherit;height: inherit;background: inherit;border-radius: 50%;-webkit-border-radius: 50%;-moz-border-radius: 50%;position: fixed;}.heart:after{top: -5px;}.heart:before{left: -5px;}"),o(),r()}function r(){for(var e=0;e<d.length;e++)d[e].alpha<=0?(t.body.removeChild(d[e].el),d.splice(e,1)):(d[e].y--,d[e].scale+=.004,d[e].alpha-=.013,d[e].el.style.cssText="left:"+d[e].x+"px;top:"+d[e].y+"px;opacity:"+d[e].alpha+";transform:scale("+d[e].scale+","+d[e].scale+") rotate(45deg);background:"+d[e].color+";z-index:99999");requestAnimationFrame(r)}function o(){var t="function"==typeof e.onclick&&e.onclick;e.onclick=function(e){t&&t(),i(e)}}function i(e){var a=t.createElement("div");a.class,d.push({el:a,x:e.clientX-5,y:e.clientY-5,scale:1,alpha:1,color:s()}),t.body.appendChild(a)}function c(e){var a=t.createElement("style");a.type="text/css";try{a.appendChild(t.createTextNode(e))}catch(t){a.styleSheet.cssText=e}t.getElementsByTagName("head")[0].appendChild(a)}function s(){return"rgb("+~~(255*Math.random())+","+~~(255*Math.random())+","+~~(255*Math.random())+")"}var d=[];e.requestAnimationFrame=function(){return e.requestAnimationFrame||e.webkitRequestAnimationFrame||e.mozRequestAnimationFrame||e.oRequestAnimationFrame||e.msRequestAnimationFrame||function(e){setTimeout(e,1e3/60)}}(),n()}(window,document);
```
...
### [](#文末添加相关文章)[文末添加相关文章](#contents:文末添加相关文章)

实现该功能的插件有两个：

<table><thead><tr><th>插件</th><th>说明</th><th>特点</th></tr></thead><tbody><tr><td><a href="https://github.com/tea3/hexo-related-popular-posts" target="_blank" rel="noopener">hexo-related-popular-posts</a></td><td>最新版本已集成，可以在主题配置文件<code>_config.yml</code>中配置。</td><td>可以利用 Google Analytics API 将高浏览量（热门）的文章按配置比例加入推荐列表。</td></tr><tr><td><a href="https://github.com/huiwang/hexo-recommended-posts" target="_blank" rel="noopener">hexo-recommended-posts</a></td><td>主题尚未集成，但插件本身支持自动显示，自定义位置请查看 README。</td><td>可以与其它博客相关联，不限于自己博客。</td></tr></tbody></table>
...
### [](#文末添加结束标语)[文末添加结束标语](#contents:文末添加结束标语)

同样需要在 `post-body-end.swig` 文件中添加内容，开启自定义文件的功能参考[上文](#%E6%96%87%E6%9C%AB%E6%B7%BB%E5%8A%A0%E7%9B%B8%E5%85%B3%E6%96%87%E7%AB%A0)。
...
### [](#文末添加今日诗词)[文末添加今日诗词](#contents:文末添加今日诗词)
...
也就是说插入的标签不应该使用之前的 `jinrishici-sentence`，需要重新命名。参考上一节配置的两个文件，把内容修改一下即可 [[6]](#fn:6)：
